...
@section('main-content')
    ...
    <div class="advantages">
        ...
        <div class="advantages__article">
            ...
            <div>
                <h5>
                <a href=""> @lang('messages.Безопасность') <i class="icon-btn-details"></i>
                </a>
                </h5>
            ...
            <div>
                <h5>
                <a href=""> @lang('messages.Инновационность') <i class="icon-btn-details"></i>
                </a>
                </h5>
            ...
            <div>
                <h5>
                <a href=""> @lang('messages.Социальная ответственность') <i class="icon-btn-details"></i>
                </a>
                </h5>
            ...
            <div>
                <h5>
                <a href=""> @lang('messages.Равные возможности для всех') <i class="icon-btn-details"></i>
                </a>
                </h5>
            ...
            <div>
                <h5>
                <a href=""> @lang('messages.Устойчивое развитие') <i class="icon-btn-details"></i>
                </a>
                </h5>
