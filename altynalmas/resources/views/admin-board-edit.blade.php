...
@section('content')
    <div class="container text-xl-center admin-text">
        Редактирование карточки в блоке "Правление" на странице "Руководство компании".
    </div>

    <div class="block admin-news-img">
        <img src="/storage/{{$board->img_url}}">
    </div>

    <div class="block">

        <div class="block-content block-content-narrow">
            <form class="form-horizontal" action="{{ route('admin-board.update', $board->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                {{ method_field('PUT') }}
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input class="form-control" type="text" id="name_kz" name="name_kz" value="{{ $board->name_kz }}">
                    </div>
                </div>
               <div class="block">
                    <div class="block">
                    ...
                    <div class="block">
                        <textarea name="position_kz" class="col-sm-12">{{ $board->position_kz }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input class="form-control" type="text" id="name_ru" name="name_ru" value="{{ $board->name_ru }}">
                    </div>
                </div>
               <div class="block">
                    <div class="block">
                    ...
                    <div class="block">
                        <textarea name="position_ru" class="col-sm-12">{{ $board->position_ru }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input class="form-control" type="text" id="name_en" name="name_en" value="{{ $board->name_en }}">
                    </div>
                </div>
               <div class="block">
                    <div class="block">
                    ...
                    <div class="block">
                        <textarea name="position_en" class="col-sm-12">{{ $board->position_en }}</textarea>
                    </div>
                </div>
