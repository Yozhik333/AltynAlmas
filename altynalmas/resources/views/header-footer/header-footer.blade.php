                      ...
                      <li class="mobile-menu__drop">
                        ...
                        <div class="mobile-menu__dropdown">
                          <ul>
                            ...
                            <li class="{{ request()->is('mission') ? 'active' : null }}">
                              <a class="mobile-menu__link" href="{{ route('mission') }}"> @lang('messages.Миссия') </a>
                            </li>
                            <li class="{{ request()->is('history') ? 'active' : null }}">
                              <a class="mobile-menu__link" class="link " href="{{ route('history') }}"> @lang('messages.История') </a>
                            </li>
                            <li class="{{ request()->is('main-directions') ? 'active' : null }}">
                              <a class="mobile-menu__link" href="{{ route('main-directions') }}"> @lang('messages.Основные направления деятельности') </a>
                            </li>
                      ...
                      <li class="mobile-menu__drop">
                        ...
                        <div class="mobile-menu__dropdown">
                          <ul>
                            ...
                            <!--                       href="">-->
                            <!--                            @lang('messages.Электронные закупки')-->
                            <!--                    </a>-->
                            <!--                </li>-->
                            <li class="{{ request()->is('suppliers-contacts') ? 'active' : null }}">
          ...
          <div class="search-wrapper">
            <div class="container-fluid">
              <form action="" method="get" class="search-form__panel" id="searchHeaderForm">
                <input type="text" name="search" value="" list = 'datalist1' id="searchHeader" class="search-form__input" autocomplete="off">
