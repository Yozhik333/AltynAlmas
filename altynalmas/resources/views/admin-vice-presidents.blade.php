...
@section('content')
    <div class="container text-xl-center admin-text">
        Здесь Вы можете добавить, изменить или удалить информацию для блока "Вицепрезиденты" на странице "Руководство компании".
    </div>

    <div class="block">

        <div class="block-content block-content-narrow">
            <form class="form-horizontal" action="{{ route('admin-vice-presidents.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <tbody>
                    ...
                    @foreach($presidents as $president)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin-vice-presidents.edit', $president->id )}}" class="btn btn-info"> Редактировать </a>
                            </td>
                            <td>
                                <form action="{{ route('admin-vice-presidents.destroy', $president->id )}}" method="post">
                                    @csrf
                                    {{method_field('DELETE')}}
