...
@section('main-content')
    ...
    <div class="banner" style="background-image: url('/img/banner-staff.jpg');">
        ...
        <div class="flex align-items-baseline">
            ...
            <div class="h1-wrap">
                <h1 class="small"> @lang('messages.Сотрудники') </h1>
            </div>
            </div>
        </div>
        </div>
    ...
    <div class="staff">
        <div class="container-fluid">
        <h2 class="underline_bottom-offset"> @lang('messages.Наши сотрудники –') <br> @lang('messages.это главный капитал компании') </h2>
        <div class="staff__block">
            <div class="staff__description">
            <p>@lang('messages.В штате компании трудятся более 2000 сотрудников. Большая часть из них специалисты высшей категории с первоклассной теоретической подготовкой и практическим опытом, которые вносят неоценимый вклад в реализацию сложных, масштабных проектов в различных областях деятельности компании.')</p>
