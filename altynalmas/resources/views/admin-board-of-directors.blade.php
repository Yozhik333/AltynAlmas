...
@section('content')
    <div class="container text-xl-center admin-text">
        Здесь Вы можете добавить, изменить или удалить информацию для блока "Совет Директоров" на странице "Руководство компании".
    </div>

    <div class="block">

        <div class="block-content block-content-narrow">
            <form class="form-horizontal" action="{{ route('admin-board-of-directors.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <tbody>
                    ...
                    @foreach($directors as $director)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin-board-of-directors.edit', $director->id )}}" class="btn btn-info"> Редактировать </a>
                            </td>
                            <td>
                                <form action="{{ route('admin-board-of-directors.destroy', $director->id )}}" method="post">
                                    @csrf
                                    {{method_field('DELETE')}}
