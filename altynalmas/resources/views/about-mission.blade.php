        ...
        <div class="advantages__banner-wrap-outside">
          <div class="advantages__banner-wrap">
            <div class="advantages__banner" style="background-image:url('img/advantages2.jpg') ">
              <div class="title">
                <div class="text-uppercase"> Принципы Акционерного общества </div>
                <div class="title-small"> «АК Алтыналмас» </div>
              </div>
            </div>
            <div class="advantages-description">
              <div class="under-title"> миссия </div>
              <div class="under-text"> Преобразуем потенциал недр в ЗОЛОТЫЕ возможности для общества, работников, инвесторов и других заинтересованных сторон. </div>
            </div>
            <div class="advantages-description">
              <div class="under-title"> видение </div>
              <div class="under-text"> Стать лидирующей компанией в среднеазиатском золотодобывающем секторе. Приоритетной географией интересов компании является Казахстан. </div>
            </div>
          </div>
        </div>
        <div class="values">
          <div class="values__head"> Ценности </div>
          <div class="values__body">
            <article class="values-article">
              <div class="values__body-title"> Устойчивое развитие </div>
              <div class="values__body-points">
                <p>В своих подходах мы ориентируемся на долгосрочное и стабильное развитие.</p>
                <ul>
            ...
            <article class="values-article">
              <div class="values__body-title"> Бережное отношение к окружающей среде </div>
              <div class="values__body-points">
                <p>Рационально используем природные ресурсы и стремимся минимизировать неблагоприятное воздействие нашей деятельности на окружающую среду.</p>
                <ul>
            ...
            <article class="values-article">
              <div class="values__body-title"> Безопасность труда </div>
              <div class="values__body-points">
                <p>Безопасность и здоровье сотрудников является нашим приоритетом.</p>
                <ul>
            ...
            <article class="values-article">
              <div class="values__body-title"> Одна команда </div>
              <div class="values__body-points">
                <p>Мы помогаем друг другу и берем на себя ответственность за командный результат.</p>
                <ul>
            ...
            <article class="values-article">
              <div class="values__body-title"> Наши люди </div>
              <div class="values__body-points">
                <p>Ценим, развиваем и заботимся о сотрудниках.</p>
                <ul>
