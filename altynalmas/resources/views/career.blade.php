    ...
    <section class="career">
        ...
        <div class="career__people">
            ...
            <div class="career__people-block">
                ...
                <div class="people-block-description"> @lang('messages.Работники имеют возможность получать высшее и средне-специальное образование. В 2019 году обучение более 30 РАБОТНИКОВ было профинансировано за счет средств работодателя') </div>
            </div>
            <div class="career__people-block">
            ...
            <div class="career__people-block">
                ...
                <div class="people-block-description"> @lang('messages.Ежегодно работники принимают участие в более 100 РАЗЛИЧНЫХ ОБУЧАЮЩИХ МЕРОПРИЯТИЯХ') </div>
            </div>
            </div>
        </div>
        <!-- /.career_people -->
        <div class="career__hr-policy flex flex-wrap">
            ...
            <ul>
                <li>@lang('messages.создание возможностей для профессионального и личного роста работников;') </li>
                <li>@lang('messages.побуждение всех работников к полному раскрытию своего потенциала;') </li>
                <li>@lang('messages.высокая производительность труда при полном соблюдении требований техники безопасности;')</li>
                <li>@lang('messages.повышение уровня жизни работников и их семей;') </li>
