...
@section('content')
    ...
    <div class="block">
        <div class="block-content block-content-narrow">
            <form class="form-horizontal" action="{{ route('admin-ecology.update', $ecology->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                {{ method_field('PUT') }}
                <div class="form-group">
                    <label class="col-sm-12" for="title_kz">Заголовок на казахском языке</label>
                    <div class="col-sm-12">
                        <input class="form-control" type="text" id="title_kz" name="title_kz" value="{{ $ecology->title_kz }}">
                    </div>
                </div>
                <div class="block">
                    <div class="block">
                    ...
                    <div class="block">
                        <textarea name="text_kz" class="js-summernote">{{ $ecology->text_kz }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input class="form-control" type="text" id="title_ru" name="title_ru" value="{{ $ecology->title_ru }}">
                    </div>
                </div>
            <div class="block">
                    <div class="block">
                    ...
                    <div class="block">
                        <textarea name="text_ru" class="js-summernote">{{ $ecology->text_ru }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input class="form-control" type="text" id="title_en" name="title_en" value="{{ $ecology->title_en }}">
                    </div>
                </div>
            <div class="block">
                    <div class="block">
                    ...
                    <div class="block">
                        <textarea name="text_en" class="js-summernote">{{ $ecology->text_en }}</textarea>
                    </div>
                </div>
