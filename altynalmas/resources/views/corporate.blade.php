...
@section('main-content')
    ...
    <div class="banner" style="background-image: url('img/corporate-banner.jpg');">
        ...
        <div class="flex align-items-baseline">
            ...
            <div class="h1-wrap">
                <h1 class="small"> Корпоративное управление </h1>
            </div>
            </div>
        </div>
        </div>
    ...
    <section class="corporate">
        ...
        <div class="flex flex-wrap">
            ...
            <div class="advantages__banner-wrap">
                ...
                <div class="advantages-buttons__title"> Корпоративные документы<br> акционерного общества «АК Алтыналмас» </div>
                <div class="flex advantages-buttons__btn-wrap">
                    <p>Кодекс противодействия коррупции</p>
                    <a href="" class="btn btn-detail"> Подробнее </a>
                </div>
                <div class="flex advantages-buttons__btn-wrap">
                    <p>Устав Акционерного общества</p>
                    <a href="" class="btn btn-detail"> Подробнее </a>
                </div>
                </div>
            </div>
